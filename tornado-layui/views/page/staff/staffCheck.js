layui.config({
    ...
    $("body").on("click", ".users_refuse", function () {  //删除
       var index = layui.layer.open({
            title: "拒绝申请",
            type: 2,
            area: ['500px', '200px'],
            ...
            if (currData.length != 0) {
                for (var i = 0; i < currData.length; i++) {
                    dataHtml += '<tr>'
                        ...
                        + '<td>'
                        + '<a class="layui-btn layui-btn-mini users_edit"><i class="iconfont icon-edit"></i>通过</a>'
                        // + '<a class="layui-btn layui-btn-danger layui-btn-mini users_del" data-id="' + data[i].usersId + '"><i class="layui-icon">&#xe640;</i> 删除</a>'
                        + '<a class="layui-btn layui-btn-warm layui-btn-mini users_refuse" data-id="' + data[i].usersId + '"><i class="layui-icon">&#x1007;</i> 拒绝</a>'
                        + '</td>'
                        + '</tr>';
                }
            } else {
