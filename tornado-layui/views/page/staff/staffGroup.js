layui.config({
    ...
    //加载页面数据
    var usersData = '';
    $.get("../../json/groupList.json", function (data) {
        usersData = data;
            ...
            if (currData.length != 0) {
                for (var i = 0; i < currData.length; i++) {
                    dataHtml += '<tr>'
                        ...
                        + '<td>' + currData[i].groupName + '</td>'
                        + '<td>' + currData[i].groupdetail + '</td>'
                        + '<td>' + currData[i].groupcount + '</td>'
                        + '<td>' + currData[i].groupCreatTime + '</td>'
                        ...
                        + '<a class="layui-btn layui-btn-warm layui-btn-mini users_del" data-id="' + data[i].usersId + '"><i class="layui-icon">&#x1007;</i> 停用</a>'
                        + '</td>'
                        + '</tr>';
                }
            } else {
